...
<html lang="en">
  ...
  <body class="tm-gray-bg">
    <script>
      let logoutMessage = localStorage.getItem("storageName");
      if (logoutMessage != null) {
        document.getElementsByClassName("success-check")textContent = logoutMessage;
      }
    </script>


<!--    <div style="width:;" id="logoutSuccess" class="screen">
      <div class="auth-success-screen content-wrapper">
        <span class="success-check"></span>
        <h2 class="screen-heading"></h2>
      </div>
