...
<html>
    ...
    <body>
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-9">
                        ...
                        <nav class="tm-nav">
                            <ul>
                                ...
                                <li><a href="customerMain.jsp" class="active">Customer Main</a></li>                                                              
        ...
        <% Customer customer = (Customer) session.getAttribute("userType");%>
        <h1 class="welcome_message">Welcome <%= customer.getCustomerName()%></h1>
        <div>
